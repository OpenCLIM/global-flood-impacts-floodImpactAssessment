cmd in folder C:\Users\steve\Documents\CityCAT-dafni\global-flood-impacts-floodImpactAssessment
start docker desktop
docker build -t flood-impact-assessment .
Run container in Docker Desktop. In Images find flood-impact-assessment. Click on the play button. Then "optional settings" and call "Container name" something like "global-flood-impact-assessment"
or docker run --name global-flood-impact-assessment flood-impact-assessment 

docker cp global-flood-impact-assessment:/data/outputs/impacts/Newcastle_exposure_summary.txt ./Newcastle_exposure_summary.txt
docker cp global-flood-impact-assessment:/data/outputs/impacts/exposure_plot.png ./exposure_plot.png

docker save -o flood-impact-assessment.tar flood-impact-assessment
compress green-areas.tar to flood-impact-assessment.tar.gz using 7Zip add to archive
